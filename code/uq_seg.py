...
# Paths
x_test_dir = (
    "/home/giulia/deepvalve/data/segmentation_data/segmentation_lines_30_2/test/images/"
)
y_test_dir = (
    "/home/giulia/deepvalve/data/segmentation_data/segmentation_lines_30_2/test/masks/"
)
...
sample_conf_intervals = [
    compute_confidence_intervals(dropout_dice_scores[:, i], confidence=0.95)
    for i in range(dropout_dice_scores.shape[1])
]
...
(
    ...
    overall_lower_bound,
    overall_upper_bound,
) = compute_confidence_intervals(overall_dice_scores, confidence=0.95)
...
output_csv_path = (
    f"/home/giulia/deepvalve/results/uncertainty_analysis_{drop_prob}b.csv"
)
