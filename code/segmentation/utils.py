...
# #        transform = Compose([
# #     # Apply a random rotation with a range of [-90, 90] degrees and a probability of 0.5
# #     Rotate(limit=(-90, 90), p=0.5),
# #     # Apply a random crop with a size of 100x100 pixels and a probability of 1
# #     RandomCrop(100, 100, p=0.6)
# # ]),album.PadIfNeeded(min_height=448, min_width=448, always_apply=True, border_mode=0),
# #     ]
# #     return album.Compose(train_transform)


# # Define a function for training augmentation 1
# def get_training_augmentation_1():
#     train_transform = [
#         # Apply a random brightness and contrast adjustment with a probability of 0.3
#         album.RandomBrightnessContrast(p=0.3),
#         # Apply a random horizontal flip with a probability of 0.5
#         album.HorizontalFlip(p=0.5),
#         # Apply a random crop with a size of 100x100 pixels and a probability of 1
#         album.RandomCrop(100, 100, p=1),
#         # Pad the image to a minimum size of 448x448 pixels with a constant border mode and a probability of 1
#         album.PadIfNeeded(min_height=448, min_width=448, always_apply=True, border_mode=0),
#     ]
#     return album.Compose(train_transform)

# # Define a function for training augmentation 2
# def get_training_augmentation_2():
#     train_transform = [
#         # Apply a random gamma correction with a probability of 0.2
#         album.RandomGamma(p=0.2),
#         # Apply a random vertical flip with a probability of 0.5
#         album.VerticalFlip(p=0.5),
#         # Apply a random resize with a scale range of [0.5, 1] and a probability of 1
#         # album.RandomScale(scale_limit=(0.5, 1), p=1),
#         # Pad the image to a minimum size of 448x448 pixels with an edge border mode and a probability of 1
#         album.PadIfNeeded(min_height=448, min_width=448, always_apply=True, border_mode=2),
#     ]
#     return album.Compose(train_transform)

# # Define a function for training augmentation 3
# def get_training_augmentation_3():
#     train_transform = [
#         # Apply a random hue and saturation adjustment with a probability of 0.4
#         # album.HueSaturationValue(p=0.4),
#         # Apply a random rotation with a range of [-90, 90] degrees and a probability of 0.5
#         album.Rotate(limit=(-90, 90), p=0.9),
#         # Apply a center crop with a size of 100x100 pixels and a probability of 1
#         album.CenterCrop(100, 100, p=1),
#         # Pad the image to a minimum size of 448x448 pixels with a reflect border mode and a probability of 1
#         album.PadIfNeeded(min_height=448, min_width=448, always_apply=True, border_mode=4),
#     ]
#     return album.Compose(train_transform)
...
#         # Pad the image to a minimum size of 448x448 pixels with a reflect border mode and a probability of 1
#         album.PadIfNeeded(min_height=448, min_width=448, always_apply=True, border_mode=4),
#         # Add Gaussian noise to the image with mean=0 and std=0.1 and a probability of 0.5
#         album.GaussNoise(var_limit=(0.0, 0.1), p=0.5),
#         # Add multiplicative noise to the image with a multiplier range of [0.98, 1.02] and a probability of 0.5
#         album.MultiplicativeNoise(multiplier=(0.98, 1.02), p=0.5),
#     ]
#     return album.Compose(train_transform)


# ## to select one of the augmenations
...
#         else:
#             raise ValueError(f"Invalid augmentation value: {value}. Supported values: 1, 2, or 3.")
