...
def main():
    ...
    config.gamma = 0.9  # 0.6
    config.augment_prop = 0
    seed = 42
    # model = "resnet50"
    ...
    config.crop_prob = 0.5  # crop or not the images in augmentation
    ...
    torch.save(
        ...
        f"unet_regression_results_exploration/{run_name}_best_model.pth",
    )
